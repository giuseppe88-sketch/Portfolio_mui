...
export default function Contact() {
  ...
  return (
    <Box
      ...
      id="contact"
    >
      <Container maxWidth="fluid" className={classes.container}>
        <Box
          display="flex"
          ...
          alignItems="center"
        >
          <Typography variant="h2" sx={{ color: "white", mt: 15 }}>
            Contact
          </Typography>
        </Box>
        <Grid
        ...
        >
          <Grid item xs={2}>
            <Box display="flex" flexDirection="column" alignItems="center">
              <Link href="mailto:giuseppeadamo908@gmail.com">
                ...
                >
                  <i>giuseppeadamo908@gmail.com</i>
                </Typography>
              </Link>
            </Box>
          </Grid>
